...
if __name__ == '__main__':
    ...
    trainset, validationset = torch.utils.data.random_split(dataset, [trainset_length, valset_length])

    trainer.fit(model, get_dataloader(trainset), get_dataloader(validationset))

    # split trainset into 2 parts
    trainset_part1, trainset_part2 = torch.utils.data.random_split(trainset, [trainset_length//2, trainset_length - trainset_length//2])
